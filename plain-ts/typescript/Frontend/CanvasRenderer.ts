...
export class CanvasRenderer {
  ...
  public setCanvas(): void {
    ...
    const canvas = this.element.getElementsByTagName(
      "canvas"
  ...
  public render(): void {
    ...
    const center = new Position(this.canvas.width / 2, this.canvas.height / 2);
    ...
    for (const cell of cells) {
      ...
      this.canvas.ctx.fillRect(x, y, cellDimension, cellDimension);
    }
  }
}
